 ...
 * @DATE 2021/9/23
 ***/
class KnowledgeAdapter(data : MutableList<ModelResponse.KnowLedgeChapter>):
	BaseQuickAdapter<ModelResponse.KnowLedgeChapter, BaseViewHolder>(R.layout.item_system,data)  {

	override fun convert(holder: BaseViewHolder, item: ModelResponse.KnowLedgeChapter) {
		holder.run {
